...
with open('train_data.txt', mode='w', encoding='utf-8') as w:
    train_data = json.dumps(train_data)
    w.writelines(train_data)
with open('train_label.txt', mode='w', encoding='utf-8') as w:
...
with open('test_data.txt', mode='w', encoding='utf-8') as w:
    test_data = json.dumps(test_data)
    w.writelines(test_data)
with open('test_label.txt', mode='w', encoding='utf-8') as w:
